import numpy as np
import pytest
from flygym_gymnasium import Fly, Camera, is_rendering_skipped
from flygym_gymnasium.examples.olfaction import OdorPlumeArena, PlumeNavigationTask
...
def test_plume_tracking_task():
    plume_data_path = get_data_path(
        "flygym_gymnasium", "data/test_data/plume_tracking/plume_short.hdf5"
    )
