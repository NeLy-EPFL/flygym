...
import flygym_gymnasium.preprogrammed as preprogrammed
import flygym_gymnasium.state as state
from flygym_gymnasium.arena import BaseArena
from flygym_gymnasium.camera import Camera
from flygym_gymnasium.fly import Fly
from flygym_gymnasium.simulation import SingleFlySimulation
...
class NeuroMechFly(SingleFlySimulation):
    ...
    spawn_orientation : tuple[float, float, float], optional
        ...
        the definition of the spawn orientation has changed since the
        v1.1.0. Please use the new API (``flygym.Simulation`` and
        ``flygym.Fly``). See documentation and tutorials at
