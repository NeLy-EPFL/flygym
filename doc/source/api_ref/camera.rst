...
The full API reference of the ``ZStabilizedCamera`` class is as follows:

.. autoclass:: flygym.camera.ZStabilizedCamera
    :members:
    :undoc-members:
    :show-inheritance:

The full API reference of the ``YawOnlyCamera`` class is as follows:

.. autoclass:: flygym.camera.YawOnlyCamera
    :members:
    :undoc-members:
    :show-inheritance:

The full API reference of the ``GravityAlignedCamera`` class is as follows:

.. autoclass:: flygym.camera.GravityAlignedCamera
    :members:
    :undoc-members:
    :show-inheritance: