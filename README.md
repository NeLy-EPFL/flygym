...
> Note: [FlyGym v1.2.0](https://github.com/NeLy-EPFL/flygym/releases/tag/v1.2.0) was the last version to official support macOS 13 but you can get newer versions work by downgrading your numpy version `pip install "numpy<2"` after installing FlyGym.
